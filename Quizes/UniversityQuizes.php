...
<div class="row container-fluid">
    ...
    $themes = $db->selectAttrInCategory('Опитування університета', 'Theme');
    $authorsName =  $db->selectAttrInCategory('Опитування університета', 'AuthorName');
    $authorsSurName =  $db->selectAttrInCategory('Опитування університета', 'AuhtorSurname');
    $date = $db->selectAttrInCategory('Опитування університета', 'Date');
    $countVotings = $db->selectAttrInCategory('Опитування університета', 'Date');
    ...
    <div class="col-md-10 col-xs-12 main">
        <h1 class="text-center display-4">Опитування університета</h1>
